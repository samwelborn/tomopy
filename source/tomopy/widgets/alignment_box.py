...
def alignment_box(meta, aligned_tomo_list, tomo, widget_linker, generalmetadata):
    ...
    grid_alignment = GridspecLayout(6, 4)
    ...
    align_SIRT_CUDA_option_list = [
        align_SIRT_CUDA_option1,
        align_SIRT_CUDA_option2,
        align_SIRT_CUDA_option3,
    ]
    ...
    fill_grid(align_SIRT_CUDA, align_SIRT_CUDA_option_list, 2, grid_alignment)
    ...
    grid_column_headers = ["Method", "Option 1", "Option 2", "Option 3"]
    ...
    grid_methods_accordion = Accordion(children=[grid_alignment], selected_index=None)
    grid_methods_accordion.set_title(0, "Alignment Methods")
    ...
    other_options_accordion.set_title(0, "Other Alignment Options")
    box = VBox(
        children=[
            hb1,
